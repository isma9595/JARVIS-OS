...
def default_command_metadata() -> tuple[CommandMetadata, ...]:
    commands = [
        ...
        _meta(
            ...
            "Show the persisted assistant interaction language preference.",
            CommandCategory.PROFILE,
            ("какой язык", "текущий язык", "покажи язык", "current language", "show language"),
            voice_auto_allowed=True,
            introduced_in="TASK-086",
            notes_ru="local preference only; no providers, network, credentials, microphone, or workflow",
        ),
        _meta(
            "profile.language.set",
            "Language preference",
            "Set the local assistant interaction language preference.",
            CommandCategory.PROFILE,
            (
                "язык русский",
            ...
            voice_auto_allowed=True,
            introduced_in="TASK-086",
            notes_ru="settings write only; no ActionRouter, providers, network, credentials, microphone, or workflow",
        ),
        _meta(
            "profile.language.reset",
            "Reset language preference",
            "Reset the assistant interaction language preference to ru-RU.",
            CommandCategory.PROFILE,
            ("сбросить язык", "reset language"),
            read_only=False,
            voice_auto_allowed=True,
            introduced_in="TASK-086",
            notes_ru="safe reset to Russian default",
        ),
